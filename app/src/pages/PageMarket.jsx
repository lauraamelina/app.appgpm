        ...
        <main className="container">
            ...
            <section className="row market">
                <div className="col-md-6">
                    ...
                    <BtnAction buttonText="Ir a comprar" route="/"/>
                ...
                <div className="col-md-6">
                    ...
                    <BtnAction buttonText="Ir a vender" route="/"/>
                </div>
            </section>
            ...
            <section className="row market-publicar">
                <div className="col-md-4 col-12">
                    ...
                    <BtnAction buttonText="Publicar producto" route="/"/>
                </div>
                ...
                <div className="col-md-4 col-12">
                    ...
                    <BtnAction buttonText="Publicar Bid" route="/"/>
                </div>
